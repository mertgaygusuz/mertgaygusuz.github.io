...
export function Hero() {
  ...
  return (
    <section className="relative flex min-h-[84svh] items-center overflow-hidden px-6 pt-28 pb-16 lg:pt-24" id="hero">
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 lg:grid-cols-[1.08fr_0.92fr]">
        ...
        >
          {/* availability */}
          <div className="mb-6 inline-flex items-center gap-2.5 text-[0.8125rem] font-medium text-on-surface-variant">
          ...
          <h1 className="font-headline text-5xl font-extrabold leading-[0.94] tracking-tight md:text-6xl lg:text-[4.75rem]">
            Mert
            <br />
          ...
          {/* credential line */}
          <div className="mt-7 flex flex-wrap items-center gap-x-3 gap-y-2 text-[0.8125rem] font-semibold text-on-surface">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="#work"
              className="group inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 font-bold text-on-primary transition-transform hover:-translate-y-0.5"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-outline-variant/50 px-6 py-3 font-bold text-on-surface transition-colors hover:border-primary/60 hover:text-primary"
            >
      ...
      <motion.a
        ...
        className="absolute bottom-5 left-1/2 hidden -translate-x-1/2 flex-col items-center gap-1 text-on-surface-variant/70 transition-colors hover:text-primary md:flex"
        animate={{ y: [0, 8, 0] }}
