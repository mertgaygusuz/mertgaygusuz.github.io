...
export function Skills() {
  ...
  return (
    <section className="py-32 px-8 md:px-24 bg-surface-container-low" id="skills">
      <div className="max-w-screen-2xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 md:auto-rows-[160px]">
          ...
          >
            ...
            <div>
              ...
              <p className="text-on-surface-variant leading-relaxed">
                Cross-platform development with native bridge optimization.
              </p>
            </div>
          </motion.div>
          ...
          {SMALL_CELLS.map((item, i) => (
            ...
            >
              ...
              <h4 className="font-label text-xs tracking-widest uppercase text-center">{item.key}</h4>
            </motion.div>
          ))}
          ...
          >
            ...
            <div>
              ...
              <p className="text-on-surface-variant text-xs">High performance endpoint design.</p>
            </div>
          </motion.div>
